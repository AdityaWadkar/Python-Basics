...
multiple lines
'''
print('*'*10 + 'First Strings' + '*'*10)
print(my_str1)
print('*'*10 + 'Second Strings' + '*'*10)
print(my_str2)
print('*'*10 + 'Third Strings' + '*'*10)
print(my_str3)

# 2 --- Removing white spaces #
print('*'*10 + '2. Removing white space ' + '*'*10)
my_str = '      Whatever, somethings else\n\n\n'
print(my_str.strip())
print('\n')

# 3 --- Removing left side white spaces #
print('*'*10 + '3. Removing white space on left' + '*'*10)
my_str = '      Whatever, somethings else\n\n'
print(my_str.lstrip())

# 4 --- Removing Right side white spaces #
print('*'*10 + '4. Removing white space on Right' + '*'*10)
my_str = '      Whatever, somethings else\n\n'
print(my_str.rstrip())

# 5 --- Split #
print('*'*10 + '5. Split 192.168.1.1' + '*'*10)
ip_addr = '192.168.1.1'
print(ip_addr.split("."))
print('\n')

# 6 --- Split White space #
print('*'*10 + '6. Split White space' + '*'*10)
